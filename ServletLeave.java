...
/**
 * Servlet implementation class ServletLeave
 */
@WebServlet("/ServletLeave")
public class ServletLeave extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rs.next()) {
			request.setAttribute("errorMessage", "The record for the entered duration of leave has already been saved.");
